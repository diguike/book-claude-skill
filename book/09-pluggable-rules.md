---
title: 插件化规则体系
feishu_url: "https://fivwvysqdz.feishu.cn/docx/BmdTdaJQNoXQVPx7v8ScBjcknOh"
...
第 8 章解决了 SKILL.md 膨胀的问题——把知识外置到 `references/`。但实际跑了一阵你会发现新问题。
...
> **"一个规则文件 2000 行"**
>
> 规则文件本身也要按子主题拆分。如果 `security.md` 膨胀到了 2000 行，拆成 `security-xss.md`、`security-injection.md`、`security-auth.md`。判断标准和第 8 章一样——超过 200 行就该考虑拆了。插件化的意义就在于拆分成本极低：拆文件、改路由，完事。
